                ...
                <Card key={teen.id} className="hover:shadow-lg transition-shadow">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      {/* Starting Balance Tip - Show when teen has $0 balance */}
                      {parseFloat(teen.balance?.currentBalance || '0.00') === 0 && (
                          ...
                          <div className="flex items-start">
                            ...
                            <div className="ml-2">
                              <p className="text-xs font-medium text-blue-800">
                                💡 Give {teen.firstName} a starting balance
                              </p>
                              <p className="text-xs text-blue-700 mt-1">
                                Click "Add Bonus" below to give {teen.firstName} some initial spending money before they start earning allowances.
                              </p>
                            </div>
                          </div>
                        </div>
